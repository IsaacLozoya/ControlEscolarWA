                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="Unidad Academica" placeholder="Unidad Academica" value="<?php if($usuario['unidad_academica_id']):echo $usuario['unidad_academica_id'];else: set_value('unidad_academica_id'); endif ?>"/>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">ID Carrera</label>
                                    <input type="text" class="form-control" name="ID Carrera" placeholder="ID Carrera" value="<?php if($usuario['carrera_id']):echo $usuario['carrera_id'];else: set_value('carrera_id'); endif ?>"/>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Plan De Estudio</label>
                                    <input type="text" class="form-control" name="Plan De Estudio" placeholder="Plan De Estudio" value="<?php if($usuario['plan_estudio_id']):echo $usuario['plan_estudio_id'];else: set_value('plan_estudio_id'); endif ?>"/>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Grupo</label>
                                    <input type="text" class="form-control" name="Grupo" placeholder="Grupo" value="<?php if($usuario['grupo_id']):echo $usuario['grupo_id'];else: set_value('grupo_id'); endif ?>"/>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Semestre</label>
                                    <input type="text" class="form-control" name="Semestre" placeholder="Semestre" value="<?php if($usuario['semestre_id']):echo $usuario['semestre_id'];else: set_value('semestre_id'); endif ?>"/>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Vigencia</label>
                                    <select class="form-control" name="vigencia">
                                        <option value="A" <?php if($usuario['vigencia'] === 'A'): echo 'selected'; endif; ?>>Activo</option>
                                        <option value="I" <?php if($usuario['vigencia'] === 'I'): echo 'selected'; endif; ?>>Inactivo</option>
                                    </select>
                                </div>
                                </div>
